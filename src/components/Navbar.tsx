...
const Navbar = ({ language }: { language: string }) => {
  return (
    <>
      <header className=" z-10 flex items-center justify-between bg-slate-200 dark:bg-slate-700 p-4 pl-8 pr-8 font-bold text-xl w-screen fixed bg-opacity-40 dark:bg-opacity-40 backdrop-blur-xl max-md:static">
